...
//        System.out.println("impureza "+a.laImpurezaDeLosDatosDeUnaMatriz(parejaDeMatrices.getValue()));
        System.out.println(" gini ponderado "+a.encontrarEnQuePosEstaLaMejorVariableYQueValorDeboCompararEnLaCondicion(ld3));
//        System.out.println("gini ponderado "+a.calcularElGiniPonderado(ld3, 32, "Estrato 6"));
